...
from esquadrao_negro.estrategias import gerar_chave_promissora, diversificar
from amuletos.persistencia import LIVROS, ler_json
from artefactos.arca import carregar_todos, guardar as guardar_reliquia
