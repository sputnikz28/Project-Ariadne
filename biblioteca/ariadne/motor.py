...
class Ariadne:
    def __init__(self):
        ...
        self.pergaminhos = sorted((BASE / "pergaminhos/2026").glob("*.json"))

    def estado_pergaminho(self, numero):
        path = BASE / "pergaminhos/2026" / f"{int(numero):03d}.json"
        if not path.exists():
    ...
    def procurar_lua(self, fase):
        ...
        resposta = {
            ...
            "pergaminhos_encontrados": len(encontrados),
    ...
    def ecos_semanais(self, semana_iso):
        ...
        ecos = []
        pergaminhos_raiz = BASE / "pergaminhos"
    ...
    def criar_papiro(self, semana_iso, dados):
        """Saves a Kor Preto papiro to biblioteca/kors_negros/papiros/semana_XX/."""
        pasta = BASE / f"kors_negros/papiros/semana_{int(semana_iso):02d}"
