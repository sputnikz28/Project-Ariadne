...
from artifacts.amulets.persistence import save_book, save_json, FUTURAS
from artifacts.amulets.sources.web_statistics import unload
...
def update_next_draw_book(world, result, corruption):
    ...
    from artifacts.amulets.persistence import ler_json
