...
UNIVERSO = 139_838_160   # C(50,5) * C(12,2) = 2_118_760 * 66
...
def rank_chave(nums, ests):
    """Índice único de (nums, ests) em [0, UNIVERSO-1]."""
    return rank_numeros(nums) * 66 + rank_estrelas(ests)


def unrank_chave(r):
    """Devolve (nums, ests) a partir de índice em [0, UNIVERSO-1]."""
    return unrank_numeros(r // 66), unrank_estrelas(r % 66)
