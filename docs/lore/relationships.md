...
| `race:clerics` *(deferred)* | Melforks, Lobisomens (see above) | — | Genetic-algorithm finalists feed the Council directly; the Ritual Celeste produces the "Escolha Humana Consagrada pelos Clérigos" | Actively opposed — the Clérigos are one of two purifying forces in the Council War **[grounded]** |
