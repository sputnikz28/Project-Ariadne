...
from lendas.registro import registar_lendas
...
def main():
    ...
    arquivo = json.loads(Path("dados/arquivo_destino.json").read_text(encoding="utf-8"))
    ...
    saida = Path("relatorios/gerados/comparacao_pos_sorteio.txt")
